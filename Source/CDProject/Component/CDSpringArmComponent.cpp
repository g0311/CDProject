...
#include "CDSpringArmComponent.h"

#include "CDProject/Character/CDCharacter.h"
#include "PhysicsEngine/PhysicsSettings.h"

void UCDSpringArmComponent::UpdateDesiredArmLocation(bool bDoTrace, bool bDoLocationLag, bool bDoRotationLag,
                                                     float DeltaTime)
{
	...
	if (Character)
	{
		...
		{
			FRotator DesiredRot = FakeRotationForRemote;
